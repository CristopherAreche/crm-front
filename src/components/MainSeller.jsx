  ...
  return (
    <section className="py-6 px-12 z-[2]  grid gird-cols-1 lg:grid-cols-6">
      ...
      <section className="col-span-2 flex flex-col gap-y-12">
        ...
        <section className="bg-gradient-to-r from-primary to-secondary relative w-full h-full flex justify-center items-center cursor-pointer group">
          <div className="absolute top-0 left-0 bg-black/30 w-full h-full py-2 opacity-0 translate-y-1 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-200 ease-in-out">
            <div className="flex justify-between w-full px-4 items-center">
                <h5>Pasa al plan Professional</h5>
                <p>50% <span>de descuento</span></p>
            </div>
            <div className="flex flex-col gap-y-2">
              <p>CRM x5</p>
              <p>Automatizacion x5</p>
              <p>Stock x5</p>
            </div>
          </div>    
          <img src={productImage} alt='product 3d icon' className="w-20 h-20" />
        </section>
      </section>
    </section>
  );
