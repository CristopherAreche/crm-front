      ...
      <header className="flex py-4 lg:py-6 items-center justify-between ">
        ...
        <section className="hidden lg:flex gap-x-8 items-center z-[3]">
          ...
          <div className="flex gap-x-2">
            ...
            <Link
              to="/auth"
              className="text-white font-medium hover:text-light transition-colors b"
            >
              LOG IN
            </Link>
          </div>
      ...
      <section className="flex flex-col lg:flex-row items-start lg:items-center justify-center h-screen pt-12  lg:pt-0">
        ...
        <section className="text-white flex flex-col gap-y-8 items-start  lg:w-[36rem] lg:h-[30rem] ">
          ...
          <div className="flex gap-x-4 z-[2]">
            <Link to="/vendedor_cliente">
              <button className="bg-gradient-to-r from-primary to-secondary px-4 py-2 rounded-xl text-white font-medium text-lg lg:text-2xl hover:scale-[1.03] transition-all ">
                Empezar Ahora
              </button>
            </Link>
            <button className="border-2 border-secondary rounded-xl p-2 px-4 text-lg lg:text-2xl hover:scale-[1.03] hover:text-white transition-all text-light font-medium ">
              Descubre mas
            </button>
          </div>
        </section>
  ...
  return <main className="bg-base h-screen overflow-hidden px-10 lg:px-20 ">
    ...
    <header className='flex py-4 lg:py-6 items-center justify-between '>
      ...
      <section className='hidden lg:flex gap-x-8 items-center z-[3]'>
        ...
        <Link to='/auth' className=" flex gap-x-1 items-center text-white font-medium hover:text-light transition-colors b"><RiUserLine className='text-2xl' /> LOG IN</Link>
      </section>
    </header>
    {/* Seccion Hero */}
    <section className='flex flex-col lg:flex-row items-start lg:items-center justify-center h-screen pt-12  lg:pt-0'>
      ...
      {/* Botones */}
       <div className='flex gap-x-4 z-[2]'>
        <button className='bg-gradient-to-r from-primary to-secondary px-4 py-2 rounded-xl text-white font-medium text-lg lg:text-2xl hover:scale-[1.03] transition-all flex gap-x-1 items-center'>Empezar Ahora</button>
        <button className='border-2 border-secondary rounded-xl p-2 px-4 text-lg lg:text-2xl hover:scale-[1.03] hover:text-white transition-all text-light font-medium flex items-center gap-x-1'>Descubre mas</button>
       </div>
      </section>
      {/* Hero Image */}
