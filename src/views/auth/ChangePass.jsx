...
export default function ChangePass() {
    ...
    const sendPassword = async () => {
        if (errorPassword || password.password.length < 8) {
            await swal("Error", 'Ambas constraseñas deben coincidir \ny tener almenos 8 caracteres. \n\nFavor de revizar los datos Ingresados', "error");
        } else {
            const info = {
                id,
                    ...
                    <div className="bg-base/40 rounded-md px-8 py-4 2xl:px-12 2xl:py-8">
                        ...
                        <article>
                            ...
                            <div className="relative flex flex-col gap-y-1">
                                <label className="font-medium text-gray-300">Contraseña nueva</label>
                                <input
                            ...
                            <div className="relative flex flex-col gap-y-1">
                                ...
                                <input
                                    ...
                                    className="bg-base-light/60 py-2 pl-10 pr-4  w-full rounded-md outline-none shadow-md"
                                />
                                {errorPassword ? <span className='text-red-900'>
