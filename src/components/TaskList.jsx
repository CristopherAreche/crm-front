    ...
    <section className=" text-white mb-6">
      ...
      <section className="grid grid-cols-2 lg:grid-cols-3 gap-4">
        <article className="bg-base-light/40 px-4 py-3 rounded-md shadow-md flex flex-col gap-y-3 items-start">
          <p className="text-ellipsis overflow-hidden  w-24 h-14 text-sm font-medium text-gray-300 ">Here are the biggest enterprise technology of 2021 so fair, in reverse chronological order.</p>
