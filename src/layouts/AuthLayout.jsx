    ...
    <main className='min-h-screen bg-base text-white flex '>
      ...
      <article className='flex flex-col  justify-center w-[28rem] 2xl:w-[32rem] mx-auto h-full'>
        <div className='bg-base/40 rounded-md px-8 py-4 2xl:px-12 2xl:py-8'>
            <h1 className='text-5xl 2xl:text-6xl font-bold mb-4 '>Descubre cómo nuestra <span className='bg-gradient-to-r from-primary  to-secondary text-transparent bg-clip-text'>CRM</span> puede ayudar a tu negocio.</h1>
            <p className='font-medium text-lg text-white/90'>Aumenta la productividad de tu equipo con nuestra CRM</p>
        </div>
      </article>
      </section>
