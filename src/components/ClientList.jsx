      ...
      <div className="w-[22rem] mx-auto overflow-x-auto lg:min-w-full py-6   lg:px-8 overflow-hidden mb-4">
              <table className="min-w-full text-center text-sm font-regular shadow-md rounded-sm   border-separate ">
                <thead
                  ...
                  <tr>
                    <th scope="col" className=" px-6 py-4">CB</th>
                    <th scope="col" className=" px-6 py-4">Nombre</th>
                    <th scope="col" className=" px-6 py-4">Total Comprado</th>
                ...
                <tbody className=" dark:border-light dark:bg-base-light/60">
                  <tr className="border-b dark:border-neutral-500">
                    ...
                    <td className="whitespace-nowrap  px-6 py-4 text-red-200">Incompleto</td>
