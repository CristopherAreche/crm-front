...
const NavModal = ({isOpen, onOpen}) => {
  ...
  return (
    ...
    <div className='flex gap-x-8 w-full justify-center items-center'>
        <Link to="/auth/register" className="bg-gradient-to-r from-primary to-secondary px-2 py-1 rounded-md text-white font-medium text-lg hover:scale-[1.03] transition-all">
            Empezar Ahora
        </Link>
        <Link
            to="/auth"
