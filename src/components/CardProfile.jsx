  ...
  return (
    ...
    <div className="flex flex-col gap-4 px-6">
      <div className="flex items-center justify-center lg:justify-start gap-2 py-4">
        <a href={github} target="_blank" class="p-2 bg-gray-100 rounded-lg hover:scale-[1.03] transition-all" rel="noreferrer">
          <BsGithub className='text-2xl'/>
        </a>
        <a href={linkedIn} target="_blank" class="p-2 bg-gray-100 rounded-lg hover:scale-[1.03] transition-all" rel="noreferrer">
