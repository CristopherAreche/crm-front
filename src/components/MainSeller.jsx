...
const itemsLastesProducst = [
  ...
  {
    source : 'https://img.freepik.com/fotos-premium/botella-leche-chupete-sobre-mesa-madera-sobre-fondo-azul_392895-186990.jpg?w=360',
    name : 'Biberon',
    sale_price: 100,
    category : 'Utensillo',
    lastest : '3'
    ...
    <section className="py-6 px-12 z-[2]  grid gird-cols-1 lg:grid-cols-6">
      ...
      <section className='col-span-4 flex flex-col gap-y-4 items-start '>
          ...
          <section className='flex flex-col gap-y-3.5'>
            <h2 className='text-3xl font-medium text-light'>Buenos dias, <span className='bg-gradient-to-r from-primary  to-secondary text-transparent bg-clip-text font-bold'>{seller.name}</span></h2>
            <p className='text-light/80 text-sm'>Hoy, 8 abr 2023 </p>
            <p className='text-sm text-light/90'>Aqui podras seguir tus movimientos, y gestionar tu procesos</p>
          </section>
          {/* Section Resume */}
          <section className='grid grid-cols-2 lg:grid-cols-3 gap-4 mb-4'>
            <article className='bg-base-light/30 shadow-md rounded-md py-2 px-3 flex flex-col items-start gap-y-2'>
              ...
              <h3 className='text-light text-3xl font-bold tracking-wide'>${seller.total_monthly_sales}</h3>
            ...
            <article className='bg-base-light/30 shadow-md rounded-md py-2 px-3 flex flex-col items-start gap-y-2'>
              ...
              <p className='text-sm font-medium text-light/80 flex gap-x-1 items-center'>Clientes <RiGroupLine /></p>
            ...
            <article className='bg-base-light/30 shadow-md rounded-md py-2 px-3 flex flex-col items-start gap-y-2'>
              ...
              <p className='text-sm font-medium text-light/80 flex gap-x-1 items-center w-28'>Productos disponibles <RiShoppingBagLine className='text-4xl'/></p>
              <footer className='flex gap-x-2 items-center'>
                <p className='flex gap-x-1 items-center text-sm '>
                  15    
                  <span className='text-xs font-medium text-emerald-200'>Hab</span>
