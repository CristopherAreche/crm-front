  ...
  return <main className="bg-base h-screen overflow-hidden px-10 lg:px-20 ">
    <header className='flex py-4 lg:py-6 items-center justify-between '>
      ...
      <ul className='hidden lg:flex gap-x-6 z-10 '>
        <li className='font-medium text-white hover:text-light transition-colors cursor-pointer'>Precios</li>
        <li className='font-medium text-white hover:text-light transition-colors cursor-pointer'>Soporte</li>
        <li className='font-medium text-white hover:text-light transition-colors cursor-pointer'>Central de ayuda</li>
        <li className='font-medium text-white hover:text-light transition-colors cursor-pointer'>Sobre nosotros</li>
      </ul>
    ...
    <section className='flex flex-col lg:flex-row items-center justify-center pt-16  lg:pt-0'>
      <section className='text-white flex flex-col gap-y-10 items-start  w-full '>
       <div>
        <h1 className='text-light text-4xl font-extrabold uppercase w-96 lg:w-[32rem] mb-2'>Optimiza tu empresa con nuestra <span className='bg-gradient-to-b from-primary  to-secondary text-transparent bg-clip-text'>CRM</span></h1>
