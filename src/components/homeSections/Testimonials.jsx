  ...
  return (
    <section className=" h-[100vh]  justify-center items-center flex flex-col gap-y-16">
      ...
      <section className="flex items-center justify-center gap-x-4 lg:gap-x-12">
        <RiArrowDropLeftLine className="text-2xl lg:text-4xl text-light bg-base-light/20 p-1 lg:p-2 box-content rounded-full cursor-pointer lg:hover:-translate-x-2 transition-transform " />
        ...
        <RiArrowDropRightLine className="text-2xl lg:text-4xl text-light bg-base-light/20 p-1 lg:p-2 box-content rounded-full cursor-pointer lg:hover:translate-x-2 transition-transform " />
      </section>
    </section>
  );
};
