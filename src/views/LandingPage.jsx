  ...
  return <main className="bg-base h-screen overflow-hidden px-10 lg:px-20 ">
    ...
    <header className='flex py-4 lg:py-6 items-center justify-between '>
      ...
      <ul className='hidden lg:flex gap-x-6 z-10 '>
        <li className='font-medium text-white/80 hover:text-white transition-colors cursor-pointer'>Precios</li>
        <li className='font-medium text-white/80 hover:text-white transition-colors cursor-pointer'>Soporte</li>
        <li className='font-medium text-white/80 hover:text-white transition-colors cursor-pointer'>Central de ayuda</li>
        <li className='font-medium text-white/80 hover:text-white transition-colors cursor-pointer'>Sobre nosotros</li>
      </ul>
