...
const SuccessPayment = () => {
  ...
  return (
    ...
    <main className='bg-base min-h-screen text-white flex items-center justify-center flex-col gap-y-6 '>
      ...
      <h1 className='text-6xl font-extrabold bg-gradient-to-r from-primary  to-secondary text-transparent bg-clip-text'>PAGO CON EXITO</h1>
      <p className='text-lg font-medium text-light w-[60vw]'><span className='text-emerald-200'>¡Felicidades!</span> Tu compra ha sido todo un éxito. Gracias por elegir nuestros productos/servicios. Nos complace haber cumplido tus expectativas y proporcionarte una experiencia de compra satisfactoria.
      </p>
